...
const PREVIEWS = {
  home: (
    <div className="space-y-2">
      ...
      <div className="flex gap-2 mt-3">
        <span className="px-2 py-0.5 rounded-md bg-accent/10 text-accent text-xs font-mono" style={{ color: '#00f0ff' }}>React</span>
        <span className="px-2 py-0.5 rounded-md bg-accent/10 text-accent text-xs font-mono" style={{ color: '#00f0ff' }}>Node.js</span>
        <span className="px-2 py-0.5 rounded-md bg-accent/10 text-accent text-xs font-mono" style={{ color: '#00f0ff' }}>TypeScript</span>
      </div>
    </div>
  ),
  about: (
  ...
  contact: (
    <div className="space-y-2">
      ...
      <p className="text-xs font-mono text-accent mt-2" style={{ color: '#00f0ff' }}>athulthomasatz@gmail.com</p>
    </div>
  ),
};
